import { BrainCircuit, Headset, Quote, ShieldUser, Webhook } from "lucide-react";
...
function App() {
  return (
    <>
          ...
          <div className="flex items-center justify-between">
            ...
            <div>
              <ul className="flex space-x-8">
                ...
                <li>
                  <a href="/about" className="text-gray-800 hover:text-gray-600">Documentation</a>
                </li>
                <li>
                  <a href="/contact" className="text-gray-800 hover:text-gray-600">Support</a>
                </li>
                <li>
                  <a href="/contact" className="text-gray-800 hover:text-gray-600">Enterprise</a>
                </li>
              </ul>
            </div>
          </div>
      ...
      <div className="mt-24 bg-[#6F3DEA] text-white w-full py-28">
        <div className="container mx-auto">
      ...
      <div className="container mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-12">
          <div className="flex flex-col gap-6">
            ...
            <div>
              <a href="" className="text-[#6F3DEA]">Try it out!</a>
            </div>
          </div>
          <div className="flex flex-col gap-6">
            <div>
